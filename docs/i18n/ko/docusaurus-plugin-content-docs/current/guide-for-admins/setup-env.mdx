...
1.  [modernGraphTool의 Github 저장소](https://github.com/potatosalad775/modernGraphTool)에서 [최신 소스 코드 zip 파일](https://github.com/potatosalad775/modernGraphTool/archive/refs/heads/main.zip)을 다운로드합니다.
2.  다운로드한 zip 파일의 압축을 해제합니다.
3.  압축 해제된 폴더 내에서 `dist` 폴더를 찾습니다. 웹사이트 운영에 필요한 파일은 오로지 dist 폴더 안에만 존재하므로, **실제 웹 서버에는 `dist` 폴더 안의 내용물만 업로드하면 됩니다.**
