...
The example above produces two independent variants — _HpTF Multi Pad Leather Pad_ and _HpTF Multi Pad Suede Pad_ — that the user can switch between via the variant dropdown in the device selector.
