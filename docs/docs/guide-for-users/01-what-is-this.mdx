---
sidebar_position: 1
description: A plain-English introduction to modernGraphTool for people who have never seen a frequency response graph before.
---
...
:::info[Want the project backstory instead?]
If you're curious about _why_ modernGraphTool exists and how it differs from the older CrinGraph, see [Why modernGraphTool?](../why-moderngraphtool). That page is about the project. This guide is about using it.
:::

Next up: [Reading the graph](./02-reading-the-graph.mdx).
