...
export default function DummyGraphPage({ colorMode, theme }: DummyGraphPageProps): ReactNode {
	...
	return (
		...
		>
			...
			>
				...
				<span style={{ color: t.primary, fontSize: '14px', fontWeight: 600 }}>&#9788;</span>
			</div>
			...
			<div className={styles.dgpContent}>
				...
				>
					...
					>
						<div className={styles.dgpMenuItem} style={{ color: withAlpha(t.baseContent, 0.25) }}>
							DEVICE
						</div>
						<div className={styles.dgpMenuItemActive}>
							<span style={{ color: t.accent }}>GRAPH</span>
							<div className={styles.dgpMenuIndicator} style={{ backgroundColor: t.accent }} />
						</div>
						<div className={styles.dgpMenuItem} style={{ color: withAlpha(t.baseContent, 0.6) }}>
							EQ
						</div>
						<div className={styles.dgpMenuItem} style={{ color: withAlpha(t.baseContent, 0.25) }}>
							MISC
