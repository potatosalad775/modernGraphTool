...
export default function SquiglinkSection() {
	...
	return (
		<AccordionSection
			...
			onToggleEnabled={(v) =>
				dispatch({ type: 'SET_FIELD', path: ['SQUIGLINK_ENABLED'], value: v })
			}
		>
			...
			<div className={styles.ceToggleRow}>
				<input
					...
					id="sq-log"
				/>
				<label htmlFor="sq-log" className={styles.ceToggleLabel}>
			...
			<div className={styles.ceToggleRow}>
				<input
					...
					id="sq-analytics"
				/>
				<label htmlFor="sq-analytics" className={styles.ceToggleLabel}>
					Enable analytics
				</label>
			</div>
			...
			<div className={styles.ceToggleRow}>
				<input
					...
					id="sq-search"
				/>
				<label htmlFor="sq-search" className={styles.ceToggleLabel}>
			...
			<div className={styles.ceToggleRow}>
				<input
					...
					id="sq-sponsor"
				/>
				<label htmlFor="sq-sponsor" className={styles.ceToggleLabel}>
					Enable sponsor features
				</label>
			</div>
		</AccordionSection>
	);
