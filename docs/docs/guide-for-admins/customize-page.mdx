...
If you are using the standard deployment method (uploading the full `dist/` folder), you do not need this section. It is only relevant for CDN deployments using `cdn-index.html`.
:::
