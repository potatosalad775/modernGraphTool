...
- **[GitHub Pages](./guide-for-admins/deployment/github-pages)** — CDN deployment hosted on GitHub for free, if you'd rather stop maintaining a web server as part of this migration.
