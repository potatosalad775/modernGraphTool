...
- **[GitHub Pages](./guide-for-admins/deployment/github-pages)** — CDN deployment hosted on GitHub for free, if you'd rather not keep running a web server for this.
