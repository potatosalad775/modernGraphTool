...
class FRDataStore {
  ...
  get(uuid: string): FRDataObject | null { return this.#map.get(uuid) ?? null; }
  ...
  set(uuid: string, obj: FRDataObject): void { this.#map.set(uuid, obj); }
  delete(uuid: string): void { this.#map.delete(uuid); }
