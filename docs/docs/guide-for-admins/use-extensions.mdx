...
│   ├── main.js
│   └── ...
├── frequency-tutorial/   # Frequency Tutorial Extension folder
│   └── ...
├── target-customizer/    # Target Customizer Extension folder
│   └── ...
├── template/             # Template folder for Extension development
│   └── ...
