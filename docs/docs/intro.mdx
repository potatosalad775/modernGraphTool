...
Everything is built-in and configurable through a single [`config.js`](./guide-for-admins/customize-page) file.

For detailed documentation on individual features, see the [Features](./category/features) section.
