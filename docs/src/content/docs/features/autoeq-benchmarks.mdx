...
description: 'How turboEQ compares with the CrinGraph optimizer, the older TypeScript one and upstream AutoEq, under the same constraints and on real measurements.'
---
