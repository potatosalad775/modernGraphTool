...
이 가이드는 modernGraphTool의 아키텍처 개요를 제공하며, 기여하거나 프로젝트를 기반으로 무언가를 구축하려는 개발자를 위한 내용입니다.
...
기여를 환영합니다! 코드 스타일, 테스트, PR 가이드라인은 [CONTRIBUTING.md](https://github.com/potatosalad775/modernGraphTool/blob/main/CONTRIBUTING.md)를 참고하세요.
