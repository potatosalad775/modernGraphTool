...
export default function ImportPanel(): ReactNode {
  ...
  const handleImport = () => {
    switch (activeTab) {
      case 'v2': return importV2();
      case 'v1': return importV1();
      case 'crin': return importCrin();
    }
  };
    ...
    <div className={styles.ceImportPanel}>
      <div className={styles.ceImportTabs}>
        <button
          ...
          onClick={() => { setActiveTab('v2'); clearMessages(); }}
        >
          Import v2
        </button>
        <button
          ...
          onClick={() => { setActiveTab('v1'); clearMessages(); }}
        >
          Convert v1
        </button>
        <button
          ...
          onClick={() => { setActiveTab('crin'); clearMessages(); }}
        >
          Convert CrinGraph
        </button>
      </div>
      ...
      <div className={styles.ceImportContent}>
        ...
        <div className={styles.ceImportActions}>
          <button type="button" className={`${styles.ceBtn} ${styles.ceBtnPrimary}`} onClick={handleImport}>
