...
If a device has **multiple samples** (the same model measured several times), the channel selector is replaced by a richer **Sample / Channel selector** that also lets you choose:
